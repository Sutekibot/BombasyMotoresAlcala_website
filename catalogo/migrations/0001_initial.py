# Generated by Django 5.2.17 on 2026-09-21 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogo.location', verbose_name='Ubicación')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_stock', models.IntegerField(default=0, verbose_name='Existencia')),
                ...
                ('weight', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='Peso')),
                ('height', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='Altura')),
                ('width', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='Ancho')),
                ('length', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='Largo')),
                ...
                ('locations', models.ManyToManyField(through='catalogo.LocationInventory', to='catalogo.location', verbose_name='Ubicaciones')),
            ],
        ),
        migrations.AddField(
            model_name='locationinventory',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogo.product', verbose_name='Producto'),
        ),
